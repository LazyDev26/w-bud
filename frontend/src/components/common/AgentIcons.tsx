...
// Cursor IDE logo — isometric cube / hexagonal gem
export function CursorIcon({ className }: { className?: string }) {
  return (
    <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" {...sz} className={className}>
      {/* Top face — lightest */}
      <path d="M12 2 L20.66 7 L12 12 L3.34 7 Z" fill="currentColor" fillOpacity="0.35" />
      {/* Left face — medium */}
      <path d="M3.34 7 L12 12 L12 22 L3.34 17 Z" fill="currentColor" fillOpacity="0.6" />
      {/* Right face — darkest */}
      <path d="M12 12 L20.66 7 L20.66 17 L12 22 Z" fill="currentColor" fillOpacity="0.9" />
    </svg>
  );
}

// OpenAI logo — the hexagonal knot
...
// GitHub Copilot logo — the pilot visor/goggles (Tabler brand-github-copilot)
